  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow mb-6">
      <div className="grid md:grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/30 text-sm"
          />
        </div>
      ...
      <div className="flex gap-2">
        <button
          type="submit"
          className="bg-brand text-white px-6 py-2 rounded-lg hover:bg-brandHover text-sm font-medium"
        >
          Aplicar filtros
        </button>
        <button
